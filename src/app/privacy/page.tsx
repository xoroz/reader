  ...
  return (
    <main style={{
      ...
      <Section h="Who runs this service">
        <p>Reader is a personal reading app and accompanying server run by Lukasz (lca@lukasz.com). There is no company, no analytics provider, and no third-party ad network. Every backend service the app talks to is hosted by the same operator on <code>apps.lukasz.com</code>.</p>
      </Section>
      ...
      <Section h="Your rights">
        ...
        <ul>
          ...
          <li>Request a full export or deletion of your account by emailing lca@lukasz.com — processed within seven days.</li>
        </ul>
      </Section>
      ...
      <Section h="Contact">
        <p>Email <a href="mailto:lca@lukasz.com" style={{ color: "#C44818" }}>lca@lukasz.com</a> for any privacy question, export request, or deletion request.</p>
      </Section>
    </main>
  );
}
